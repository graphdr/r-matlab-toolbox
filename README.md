...
- [Bode plot test case](scripts/01_bode_test.md) [(script only)](scripts/01_bode_test.txt)
- [Write a MATLAB function from R](scripts/02_functions.md) [(script only)](scripts/02_functions.txt)
