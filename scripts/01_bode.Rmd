...
- If you want a complete script to execute right now, copy and save [01_bode-handout.Rmd](01_bode-handout.Rmd) as an Rmd script in the `scripts\` directory and knit.
