...
If you want a complete script to execute right now, copy and save [03_bode_script.Rmd](03_bode_script.Rmd) as an Rmd script in the `scripts\` directory and knit. 
